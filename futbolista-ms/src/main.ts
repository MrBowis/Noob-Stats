...
async function bootstrap() {
  ...
  const swaggerConfig = new DocumentBuilder()
    .setTitle('Jugadores Microservice')
    .setDescription(
      'API del perfil deportivo del futbolista amateur de Noob Stats: datos físicos, posiciones, pierna hábil, atributos y lesiones. Las estadísticas de partidos son responsabilidad de equipos-ms.',
    )
    .setVersion('1.0')
    .addBearerAuth()
    .build();
